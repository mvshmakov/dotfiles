{
  # TODO: offending sudo mistakes
  description = "mvshmakov's darwin system";
  ...
  inputs = {
    ...
    # Wraps together nix shell -c and nix-index. Usage: `, cowsay neato`
      ...
      mvshmakov-mpb-16  = darwinSystem {
        ...
        modules = attrValues self.darwinModules ++ [ 
          ...
          home-manager.darwinModules.home-manager
          {
            ...
            home-manager.users.mvshmakov = import ./home.nix;            
          }
        ];
      };
    };
